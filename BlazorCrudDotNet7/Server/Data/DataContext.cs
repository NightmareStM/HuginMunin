        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Note>().HasData(
                    new Note
                    {
                        ...
                        Tag = "pipette",
                        Update = new DateTime(7013, 07, 17, 18, 59, 34),
                        Create = new DateTime(7013, 07, 17, 18, 59, 34)
                    },
                    new Note
                    {
                        Id = 2,
                        ...
                        Create = new DateTime(2023, 05, 16, 17, 04, 00)
                    },
                    new Note
                    {
                        Id = 3,
                        ...
                        Create = new DateTime(2023, 05, 17, 12, 30, 00)
                    },
                    new Note
                    {
                        Id = 4,
                        ...
                        Create = new DateTime(2023, 05, 17, 12, 31, 00)
                    }
                );
        }
